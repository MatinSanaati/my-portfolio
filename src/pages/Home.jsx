...
import "./Home.css";
import ProfileImg from "../assets/img/profile-img/profle-img.jpg";
          ...
          <div className="intro-content">
            <div className="intro-text-wrapper">
              <h2 className="intro-title">
                ...
                <span
                  className={`cursor ${
                    !isDeleting && subIndex < texts[index].length
                      ? "visible"
                      : ""
                  }`}
                ></span>
              ...
              <p className="intro-text">
                یک توسعه‌دهندهٔ فرانت‌اند علاقه‌مند به ساخت تجربه‌های کاربری
                تعاملی و زیبا. با React، Next، Redux و فناوری‌های مدرن وب کار
                می‌کنم.
              </p>
      ...
      <section className="section blog-section">
        <div className="container">
          ...
          <div className="blog-post">
            ...
            <p>
              پورتفولیو تنها راه نمایش مهارت‌های عملی برنامه نویساس. در دنیای
              رقابتی امروز، شرکت‌ها به دنبال افرادی هستند که بتوانند نشان بدهند
              چجوری فکر می‌کنند و چجوری مشکلات را حل می‌کنند — نه اینکه صرفا چه
              فناوری‌هایی بلدند و چجوری سورس میزنن . . . !
              <br />
      ...
      <section className="section projects-preview">
        <div className="container">
          ...
          <p className="preview-text">
            چند تا از پروژه‌هایی که با عشق ساختم رو ببین 😍
          </p>
          ...
          <Link
            to="/projects"
            className="btn-section-projects-preview projects-btn"
          >
            مشاهده همه پروژه‌ها
            <span className="arrow-wrapper">
              <LeftArrowIcon />
